...
// tests for DirectionsTransitVehicle
void main() {
  final instance = DirectionsTransitVehicleBuilder();
  // TODO add properties to the builder and call build()

  group(DirectionsTransitVehicle, () {
    ...
    // String localIcon
    test('to test the property `localIcon`', () async {
      // TODO
    });
  });
}
