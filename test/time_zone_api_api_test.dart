...
/// tests for TimeZoneAPIApi
void main() {
  final instance = GooglesMapsServicesDart().getTimeZoneAPIApi();

  group(TimeZoneAPIApi, () {
    ...
    //
    //Future<TimeZoneResponse> timezone(String location, num timestamp, { String language }) async
