...
// tests for DirectionsRoute
void main() {
  final instance = DirectionsRouteBuilder();
  // TODO add properties to the builder and call build()

  group(DirectionsRoute, () {
    ...
    // Bounds bounds
    test('to test the property `bounds`', () async {
      // TODO
    });
    ...
    // BuiltList<int> waypointOrder
    test('to test the property `waypointOrder`', () async {
      // TODO
    });
    ...
    test('to test the property `overviewPolyline`', () async {
      // TODO
    });
