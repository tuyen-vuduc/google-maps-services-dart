...
// tests for DirectionsStep
void main() {
  final instance = DirectionsStepBuilder();
  // TODO add properties to the builder and call build()

  group(DirectionsStep, () {
    ...
    test('to test the property `htmlInstructions`', () async {
      // TODO
    });

    // DirectionsPolyline polyline
    test('to test the property `polyline`', () async {
      // TODO
    });
    ...
    test('to test the property `travelMode`', () async {
      // TODO
    });
    ...
    // String maneuver
    test('to test the property `maneuver`', () async {
      // TODO
    });

    // DirectionsTransitDetails transitDetails
    test('to test the property `transitDetails`', () async {
      // TODO
    });
