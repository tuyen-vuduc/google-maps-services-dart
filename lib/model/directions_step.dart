...
abstract class DirectionsStep
    implements Built<DirectionsStep, DirectionsStepBuilder> {
  ...
  factory DirectionsStep([void updates(DirectionsStepBuilder b)]) =
      _$DirectionsStep;

  @BuiltValueSerializer(custom: true)
  static Serializer<DirectionsStep> get serializer =>
      _$DirectionsStepSerializer();
}

class _$DirectionsStepSerializer
    implements StructuredSerializer<DirectionsStep> {
  @override
...
class DirectionsStepManeuverEnum extends EnumClass {
  ...
  static const DirectionsStepManeuverEnum roundaboutRight =
      _$directionsStepManeuverEnum_roundaboutRight;

  static Serializer<DirectionsStepManeuverEnum> get serializer =>
      _$directionsStepManeuverEnumSerializer;

  const DirectionsStepManeuverEnum._(String name) : super(name);

  static BuiltSet<DirectionsStepManeuverEnum> get values =>
      _$directionsStepManeuverEnumValues;
