...
abstract class PlacesFindPlaceFromTextResponse implements Built<PlacesFindPlaceFromTextResponse, PlacesFindPlaceFromTextResponseBuilder> {
    ...
    factory PlacesFindPlaceFromTextResponse([void updates(PlacesFindPlaceFromTextResponseBuilder b)]) = _$PlacesFindPlaceFromTextResponse;

    @BuiltValueSerializer(custom: true)
    static Serializer<PlacesFindPlaceFromTextResponse> get serializer => _$PlacesFindPlaceFromTextResponseSerializer();
}

class _$PlacesFindPlaceFromTextResponseSerializer implements StructuredSerializer<PlacesFindPlaceFromTextResponse> {

    @override
    final Iterable<Type> types = const [PlacesFindPlaceFromTextResponse, _$PlacesFindPlaceFromTextResponse];
    @override
