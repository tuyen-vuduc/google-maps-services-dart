...
abstract class PlacesAutocompleteResponse
    implements
        Built<PlacesAutocompleteResponse, PlacesAutocompleteResponseBuilder> {
  ...
  factory PlacesAutocompleteResponse(
          [void updates(PlacesAutocompleteResponseBuilder b)]) =
      _$PlacesAutocompleteResponse;

  @BuiltValueSerializer(custom: true)
  static Serializer<PlacesAutocompleteResponse> get serializer =>
      _$PlacesAutocompleteResponseSerializer();
}

class _$PlacesAutocompleteResponseSerializer
    implements StructuredSerializer<PlacesAutocompleteResponse> {
  @override
  ...
  Iterable<Object?> serialize(
      Serializers serializers, PlacesAutocompleteResponse object,
      {FullType specifiedType = FullType.unspecified}) {
    final result = <Object?>[];
    result
      ..add(r'predictions')
      ..add(object.predictions == null
          ? null
          : serializers.serialize(object.predictions,
  ...
  @override
  PlacesAutocompleteResponse deserialize(
