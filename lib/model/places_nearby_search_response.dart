...
abstract class PlacesNearbySearchResponse
    implements
        Built<PlacesNearbySearchResponse, PlacesNearbySearchResponseBuilder> {
  ...
  static void _initializeBuilder(PlacesNearbySearchResponseBuilder b) => b;

  factory PlacesNearbySearchResponse(
          [void updates(PlacesNearbySearchResponseBuilder b)]) =
      _$PlacesNearbySearchResponse;

  @BuiltValueSerializer(custom: true)
  static Serializer<PlacesNearbySearchResponse> get serializer =>
      _$PlacesNearbySearchResponseSerializer();
}

class _$PlacesNearbySearchResponseSerializer
    implements StructuredSerializer<PlacesNearbySearchResponse> {
  @override
  ...
  Iterable<Object?> serialize(
      Serializers serializers, PlacesNearbySearchResponse object,
  ...
  @override
  PlacesNearbySearchResponse deserialize(
