...
class _$DirectionsRouteSerializer implements StructuredSerializer<DirectionsRoute> {
    ...
    Iterable<Object> serialize(Serializers serializers, DirectionsRoute object,
        ...
        result
            ..add(r'bounds')
            ..add(object.bounds == null ? null : serializers.serialize(object.bounds,
                specifiedType: const FullType(Bounds)));
        result
            ..add(r'copyrights')
            ..add(object.copyrights == null ? null : serializers.serialize(object.copyrights,
                specifiedType: const FullType(String)));
        result
            ..add(r'summary')
            ..add(object.summary == null ? null : serializers.serialize(object.summary,
                specifiedType: const FullType(String)));
        result
            ..add(r'waypoint_order')
            ..add(object.waypointOrder == null ? null : serializers.serialize(object.waypointOrder,
                specifiedType: const FullType(BuiltList, [FullType(int)])));
        result
            ..add(r'warnings')
            ..add(object.warnings == null ? null : serializers.serialize(object.warnings,
                specifiedType: const FullType(BuiltList, [FullType(String)])));
        result
            ..add(r'overview_polyline')
            ..add(object.overviewPolyline == null ? null : serializers.serialize(object.overviewPolyline,
