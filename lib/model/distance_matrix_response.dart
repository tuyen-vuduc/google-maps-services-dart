...
abstract class DistanceMatrixResponse
    implements Built<DistanceMatrixResponse, DistanceMatrixResponseBuilder> {
  ...
  factory DistanceMatrixResponse(
          [void updates(DistanceMatrixResponseBuilder b)]) =
      _$DistanceMatrixResponse;

  @BuiltValueSerializer(custom: true)
  static Serializer<DistanceMatrixResponse> get serializer =>
      _$DistanceMatrixResponseSerializer();
}

class _$DistanceMatrixResponseSerializer
    implements StructuredSerializer<DistanceMatrixResponse> {
  @override
  ...
  Iterable<Object?> serialize(
      Serializers serializers, DistanceMatrixResponse object,
      {FullType specifiedType = FullType.unspecified}) {
    final result = <Object?>[];
    result
      ..add(r'origin_addresses')
      ..add(object.originAddresses == null
          ? null
          : serializers.serialize(object.originAddresses,
              specifiedType: const FullType(BuiltList, [FullType(String)])));
    result
      ..add(r'destination_addresses')
      ..add(object.destinationAddresses == null
          ? null
          : serializers.serialize(object.destinationAddresses,
              specifiedType: const FullType(BuiltList, [FullType(String)])));
    result
      ..add(r'rows')
      ..add(object.rows == null
          ? null
          : serializers.serialize(object.rows,
              specifiedType:
                  const FullType(BuiltList, [FullType(DistanceMatrixRow)])));
    result
      ..add(r'status')
  ...
  @override
  DistanceMatrixResponse deserialize(
      ...
      switch (key) {
        ...
        case r'rows':
          result.rows.replace(serializers.deserialize(value,
                  specifiedType:
                      const FullType(BuiltList, [FullType(DistanceMatrixRow)]))
              as BuiltList<DistanceMatrixRow>);
          break;
        case r'status':
          result.status = serializers.deserialize(value,
                  specifiedType: const FullType(DistanceMatrixStatus))
              as DistanceMatrixStatus?;
          break;
      }
    }
    return result.build();
