...
class _$PlaceAutocompletePredictionSerializer
  ...
  Iterable<Object?> serialize(
    ...
    result
      ...
      ..add(object.matchedSubstrings == null
          ? null
          : serializers.serialize(object.matchedSubstrings,
              specifiedType: const FullType(
                  BuiltList, [FullType(PlaceAutocompleteMatchedSubstring)])));
    result
      ..add(r'structured_formatting')
      ..add(object.structuredFormatting == null
          ? null
          : serializers.serialize(object.structuredFormatting,
              specifiedType:
                  const FullType(PlaceAutocompleteStructuredFormat)));
    result
      ..add(r'terms')
      ..add(object.terms == null
          ? null
