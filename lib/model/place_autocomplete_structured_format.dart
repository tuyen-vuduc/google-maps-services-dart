...
abstract class PlaceAutocompleteStructuredFormat
  ...
  static void _initializeBuilder(PlaceAutocompleteStructuredFormatBuilder b) =>
      b;
...
class _$PlaceAutocompleteStructuredFormatSerializer
  ...
  Iterable<Object?> serialize(
    ...
    result
      ..add(r'main_text')
      ..add(object.mainText == null
          ? null
          : serializers.serialize(object.mainText,
              specifiedType: const FullType(String)));
    result
      ..add(r'main_text_matched_substrings')
      ..add(object.mainTextMatchedSubstrings == null
          ? null
          : serializers.serialize(object.mainTextMatchedSubstrings,
              specifiedType: const FullType(
                  BuiltList, [FullType(PlaceAutocompleteMatchedSubstring)])));
    result
      ..add(r'secondary_text')
      ..add(object.secondaryText == null
          ? null
          : serializers.serialize(object.secondaryText,
              specifiedType: const FullType(String)));
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        ...
        case r'main_text_matched_substrings':
          result.mainTextMatchedSubstrings.replace(serializers.deserialize(
                  value,
                  specifiedType: const FullType(
                      BuiltList, [FullType(PlaceAutocompleteMatchedSubstring)]))
        ...
        case r'secondary_text_matched_substrings':
          result.secondaryTextMatchedSubstrings.replace(serializers.deserialize(
                  value,
                  specifiedType: const FullType(
                      BuiltList, [FullType(PlaceAutocompleteMatchedSubstring)]))
              as BuiltList<PlaceAutocompleteMatchedSubstring>);
