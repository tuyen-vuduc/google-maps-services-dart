...
class DirectionsAPIApi {
  ...
  Future<Response<DirectionsResponse>> directions({ 
    ...
    final _queryParameters = <String, dynamic>{
      ...
      if (alternatives != null) r'alternatives': encodeQueryParameter(_serializers, alternatives, const FullType(bool)),
      ...
      r'origin': encodeQueryParameter(_serializers, origin, const FullType(String)),
      if (units != null) r'units': encodeQueryParameter(_serializers, units, const FullType(String)),
      if (waypoints != null) r'waypoints': encodeQueryParameter(_serializers, waypoints, const FullType(String)),
