...
import 'package:google_maps_services_dart/src/model/distance_matrix_response.dart';
...
class DistanceMatrixAPIApi {
  ...
  Future<Response<DistanceMatrixResponse>> distanceMatrix({
    ...
    final _queryParameters = <String, dynamic>{
      ...
      r'destinations': encodeCollectionQueryParameter<String>(
        _serializers,
        destinations,
        const FullType(BuiltList, [FullType(String)]),
        format: ListFormat.pipes,
      ),
      r'origins': encodeCollectionQueryParameter<String>(
        _serializers,
        origins,
        const FullType(BuiltList, [FullType(String)]),
        format: ListFormat.pipes,
