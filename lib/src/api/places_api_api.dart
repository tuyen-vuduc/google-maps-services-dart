...
class PlacesAPIApi {
  ...
  Future<Response<PlacesAutocompleteResponse>> autocomplete({ 
    ...
    final _queryParameters = <String, dynamic>{
      r'input': encodeQueryParameter(_serializers, input, const FullType(String)),
      if (sessiontoken != null) r'sessiontoken': encodeQueryParameter(_serializers, sessiontoken, const FullType(String)),
      if (components != null) r'components': encodeQueryParameter(_serializers, components, const FullType(String)),
      if (strictbounds != null) r'strictbounds': encodeQueryParameter(_serializers, strictbounds, const FullType(bool)),
  ...
  Future<Response<PlacesFindPlaceFromTextResponse>> findPlaceFromText({ 
    ...
    final _queryParameters = <String, dynamic>{
      ...
      r'input': encodeQueryParameter(_serializers, input, const FullType(String)),
      r'inputtype': encodeQueryParameter(_serializers, inputtype, const FullType(String)),
      if (locationbias != null) r'locationbias': encodeQueryParameter(_serializers, locationbias, const FullType(String)),
      if (language != null) r'language': encodeQueryParameter(_serializers, language, const FullType(String)),
    };
  ...
  Future<Response<PlacesNearbySearchResponse>> nearbySearch({ 
    ...
    final _queryParameters = <String, dynamic>{
      ...
      if (maxprice != null) r'maxprice': encodeQueryParameter(_serializers, maxprice, const FullType(String)),
      if (minprice != null) r'minprice': encodeQueryParameter(_serializers, minprice, const FullType(String)),
      ...
      if (rankby != null) r'rankby': encodeQueryParameter(_serializers, rankby, const FullType(String)),
      if (radius != null) r'radius': encodeQueryParameter(_serializers, radius, const FullType(num)),
  ...
  Future<Response<PlacesDetailsResponse>> placeDetails({ 
    ...
    final _queryParameters = <String, dynamic>{
      r'place_id': encodeQueryParameter(_serializers, placeId, const FullType(String)),
      if (fields != null) r'fields': encodeCollectionQueryParameter<String>(_serializers, fields, const FullType(BuiltList, [FullType(String)]), format: ListFormat.csv,),
      if (sessiontoken != null) r'sessiontoken': encodeQueryParameter(_serializers, sessiontoken, const FullType(String)),
      if (language != null) r'language': encodeQueryParameter(_serializers, language, const FullType(String)),
  ...
  Future<Response<Uint8List>> placePhoto({ 
    ...
    final _queryParameters = <String, dynamic>{
      r'photo_reference': encodeQueryParameter(_serializers, photoReference, const FullType(String)),
      if (maxheight != null) r'maxheight': encodeQueryParameter(_serializers, maxheight, const FullType(num)),
      if (maxwidth != null) r'maxwidth': encodeQueryParameter(_serializers, maxwidth, const FullType(num)),
    };
