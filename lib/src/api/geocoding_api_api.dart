...
class GeocodingAPIApi {
  ...
  Future<Response<GeocodingResponse>> geocode({ 
    ...
    final _queryParameters = <String, dynamic>{
      ...
      if (bounds != null) r'bounds': encodeCollectionQueryParameter<String>(_serializers, bounds, const FullType(BuiltList, [FullType(String)]), format: ListFormat.multi,),
      if (components != null) r'components': encodeCollectionQueryParameter<String>(_serializers, components, const FullType(BuiltList, [FullType(String)]), format: ListFormat.pipes,),
      if (latlng != null) r'latlng': encodeQueryParameter(_serializers, latlng, const FullType(String)),
      if (locationType != null) r'location_type': encodeCollectionQueryParameter<String>(_serializers, locationType, const FullType(BuiltList, [FullType(String)]), format: ListFormat.pipes,),
      if (placeId != null) r'place_id': encodeQueryParameter(_serializers, placeId, const FullType(String)),
      if (resultType != null) r'result_type': encodeCollectionQueryParameter<String>(_serializers, resultType, const FullType(BuiltList, [FullType(String)]), format: ListFormat.pipes,),
