...
class _$ErrorDetail extends ErrorDetail {
  ...
  _$ErrorDetail._({required this.message, required this.reason, this.domain})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(message, 'ErrorDetail', 'message');
    BuiltValueNullFieldError.checkNotNull(reason, 'ErrorDetail', 'reason');
  }
