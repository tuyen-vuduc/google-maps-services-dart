...
class _$PlacesNearbySearchResponse extends PlacesNearbySearchResponse {
  ...
  _$PlacesNearbySearchResponse._(
    ...
    BuiltValueNullFieldError.checkNotNull(
        htmlAttributions, 'PlacesNearbySearchResponse', 'htmlAttributions');
    BuiltValueNullFieldError.checkNotNull(
        results, 'PlacesNearbySearchResponse', 'results');
    BuiltValueNullFieldError.checkNotNull(
        status, 'PlacesNearbySearchResponse', 'status');
  }
...
class PlacesNearbySearchResponseBuilder
  ...
  PlacesNearbySearchResponseBuilder() {
    PlacesNearbySearchResponse._defaults(this);
  }
