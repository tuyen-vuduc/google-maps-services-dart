...
abstract class PlacesDetailsResponse implements Built<PlacesDetailsResponse, PlacesDetailsResponseBuilder> {
    ...
    factory PlacesDetailsResponse([void updates(PlacesDetailsResponseBuilder b)]) = _$PlacesDetailsResponse;

    @BuiltValueSerializer(custom: true)
    static Serializer<PlacesDetailsResponse> get serializer => _$PlacesDetailsResponseSerializer();
}

class _$PlacesDetailsResponseSerializer implements StructuredSerializer<PlacesDetailsResponse> {
    @override
    final Iterable<Type> types = const [PlacesDetailsResponse, _$PlacesDetailsResponse];
