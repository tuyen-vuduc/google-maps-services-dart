...
class _$Geometry extends Geometry {
  ...
  _$Geometry._({required this.location, required this.viewport}) : super._() {
    BuiltValueNullFieldError.checkNotNull(location, 'Geometry', 'location');
    BuiltValueNullFieldError.checkNotNull(viewport, 'Geometry', 'viewport');
  }
...
class GeometryBuilder implements Builder<Geometry, GeometryBuilder> {
  ...
  _$Geometry build() {
    ...
    try {
      _$result = _$v ??
          new _$Geometry._(
              location: location.build(), viewport: viewport.build());
    } catch (_) {
