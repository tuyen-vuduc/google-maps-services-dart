...
class _$TextValueObject extends TextValueObject {
  ...
  _$TextValueObject._({required this.text, required this.value}) : super._() {
    BuiltValueNullFieldError.checkNotNull(text, 'TextValueObject', 'text');
    BuiltValueNullFieldError.checkNotNull(value, 'TextValueObject', 'value');
  }
...
class TextValueObjectBuilder
  ...
  TextValueObjectBuilder() {
    TextValueObject._defaults(this);
  }
  ...
  _$TextValueObject build() {
    final _$result = _$v ??
        new _$TextValueObject._(
            text: BuiltValueNullFieldError.checkNotNull(
                text, 'TextValueObject', 'text'),
            value: BuiltValueNullFieldError.checkNotNull(
                value, 'TextValueObject', 'value'));
    replace(_$result);
    return _$result;
  }
}
