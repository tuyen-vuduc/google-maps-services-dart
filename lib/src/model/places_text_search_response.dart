...
abstract class PlacesTextSearchResponse implements Built<PlacesTextSearchResponse, PlacesTextSearchResponseBuilder> {
    ...
    static void _defaults(PlacesTextSearchResponseBuilder b) => b;

    factory PlacesTextSearchResponse([void updates(PlacesTextSearchResponseBuilder b)]) = _$PlacesTextSearchResponse;

    @BuiltValueSerializer(custom: true)
    static Serializer<PlacesTextSearchResponse> get serializer => _$PlacesTextSearchResponseSerializer();
}

class _$PlacesTextSearchResponseSerializer implements StructuredSerializer<PlacesTextSearchResponse> {
    @override
    final Iterable<Type> types = const [PlacesTextSearchResponse, _$PlacesTextSearchResponse];

    @override
    final String wireName = r'PlacesTextSearchResponse';

    @override
    Iterable<Object?> serialize(Serializers serializers, PlacesTextSearchResponse object,
    ...
    @override
    PlacesTextSearchResponse deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
