...
abstract class SnappedPoint implements Built<SnappedPoint, SnappedPointBuilder> {
    ...
    static void _defaults(SnappedPointBuilder b) => b;
            ...
            switch (key) {
                case r'location':
                    final valueDes = serializers.deserialize(value,
                        specifiedType: const FullType(LatitudeLongitudeLiteral)) as LatitudeLongitudeLiteral;
