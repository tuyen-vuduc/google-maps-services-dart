...
class _$PlacesDetailsResponse extends PlacesDetailsResponse {
  ...
  _$PlacesDetailsResponse._(
    ...
    BuiltValueNullFieldError.checkNotNull(
        htmlAttributions, 'PlacesDetailsResponse', 'htmlAttributions');
    BuiltValueNullFieldError.checkNotNull(
        result, 'PlacesDetailsResponse', 'result');
    BuiltValueNullFieldError.checkNotNull(
        status, 'PlacesDetailsResponse', 'status');
  }
...
class PlacesDetailsResponseBuilder
  ...
  PlacesDetailsResponseBuilder() {
    PlacesDetailsResponse._defaults(this);
  }
