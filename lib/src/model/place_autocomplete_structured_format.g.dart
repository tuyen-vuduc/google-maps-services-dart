...
class _$PlaceAutocompleteStructuredFormat
  ...
  _$PlaceAutocompleteStructuredFormat._(
    ...
    BuiltValueNullFieldError.checkNotNull(mainTextMatchedSubstrings,
        'PlaceAutocompleteStructuredFormat', 'mainTextMatchedSubstrings');
    BuiltValueNullFieldError.checkNotNull(
        secondaryText, 'PlaceAutocompleteStructuredFormat', 'secondaryText');
  }
...
class PlaceAutocompleteStructuredFormatBuilder
  ...
  PlaceAutocompleteStructuredFormatBuilder() {
    PlaceAutocompleteStructuredFormat._defaults(this);
  }
