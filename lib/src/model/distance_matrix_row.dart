...
abstract class DistanceMatrixRow implements Built<DistanceMatrixRow, DistanceMatrixRowBuilder> {
    ...
    static void _defaults(DistanceMatrixRowBuilder b) => b;

    factory DistanceMatrixRow([void updates(DistanceMatrixRowBuilder b)]) = _$DistanceMatrixRow;

    @BuiltValueSerializer(custom: true)
    static Serializer<DistanceMatrixRow> get serializer => _$DistanceMatrixRowSerializer();
}

class _$DistanceMatrixRowSerializer implements StructuredSerializer<DistanceMatrixRow> {
    @override
    ...
    Iterable<Object?> serialize(Serializers serializers, DistanceMatrixRow object,
        ...
        result
            ...
            ..add(serializers.serialize(object.elements,
                specifiedType: const FullType(BuiltList, [FullType(DistanceMatrixElement)])));
        return result;
    }
            ...
            switch (key) {
                case r'elements':
                    final valueDes = serializers.deserialize(value,
                        specifiedType: const FullType(BuiltList, [FullType(DistanceMatrixElement)])) as BuiltList<DistanceMatrixElement>;
