...
abstract class NearestRoadsErrorResponse implements Built<NearestRoadsErrorResponse, NearestRoadsErrorResponseBuilder> {
    ...
    factory NearestRoadsErrorResponse([void updates(NearestRoadsErrorResponseBuilder b)]) = _$NearestRoadsErrorResponse;

    @BuiltValueSerializer(custom: true)
    static Serializer<NearestRoadsErrorResponse> get serializer => _$NearestRoadsErrorResponseSerializer();
}

class _$NearestRoadsErrorResponseSerializer implements StructuredSerializer<NearestRoadsErrorResponse> {
    @override
    final Iterable<Type> types = const [NearestRoadsErrorResponse, _$NearestRoadsErrorResponse];
            ...
            switch (key) {
                case r'error':
                    final valueDes = serializers.deserialize(value,
                        specifiedType: const FullType(NearestRoadsError)) as NearestRoadsError;
