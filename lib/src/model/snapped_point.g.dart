...
class _$SnappedPoint extends SnappedPoint {
  ...
  _$SnappedPoint._(
      {required this.location, required this.placeId, this.originalIndex})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(location, 'SnappedPoint', 'location');
    BuiltValueNullFieldError.checkNotNull(placeId, 'SnappedPoint', 'placeId');
  }
...
class SnappedPointBuilder
  ...
  set originalIndex(num? originalIndex) =>
      _$this._originalIndex = originalIndex;

  SnappedPointBuilder() {
    SnappedPoint._defaults(this);
  }
