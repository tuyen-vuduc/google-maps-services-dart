...
class _$ErrorObject extends ErrorObject {
  ...
  _$ErrorObject._(
      ...
      this.status})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(code, 'ErrorObject', 'code');
    BuiltValueNullFieldError.checkNotNull(message, 'ErrorObject', 'message');
    BuiltValueNullFieldError.checkNotNull(errors, 'ErrorObject', 'errors');
  }
