...
class _$PlaceOpeningHoursPeriodDetail extends PlaceOpeningHoursPeriodDetail {
  ...
  _$PlaceOpeningHoursPeriodDetail._({required this.day, required this.time})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(
        day, 'PlaceOpeningHoursPeriodDetail', 'day');
    BuiltValueNullFieldError.checkNotNull(
        time, 'PlaceOpeningHoursPeriodDetail', 'time');
  }
...
class PlaceOpeningHoursPeriodDetailBuilder
  ...
  PlaceOpeningHoursPeriodDetailBuilder() {
    PlaceOpeningHoursPeriodDetail._defaults(this);
  }
  ...
  _$PlaceOpeningHoursPeriodDetail build() {
    final _$result = _$v ??
        new _$PlaceOpeningHoursPeriodDetail._(
