...
class _$DirectionsStep extends DirectionsStep {
  ...
  _$DirectionsStep._(
    ...
    BuiltValueNullFieldError.checkNotNull(
        endLocation, 'DirectionsStep', 'endLocation');
    BuiltValueNullFieldError.checkNotNull(
        htmlInstructions, 'DirectionsStep', 'htmlInstructions');
    BuiltValueNullFieldError.checkNotNull(
        polyline, 'DirectionsStep', 'polyline');
    BuiltValueNullFieldError.checkNotNull(
        startLocation, 'DirectionsStep', 'startLocation');
    BuiltValueNullFieldError.checkNotNull(
        travelMode, 'DirectionsStep', 'travelMode');
  }
    ...
    try {
      _$result = _$v ??
          new _$DirectionsStep._(
              ...
              htmlInstructions: BuiltValueNullFieldError.checkNotNull(
                  htmlInstructions, 'DirectionsStep', 'htmlInstructions'),
              polyline: polyline.build(),
              startLocation: startLocation.build(),
              travelMode: BuiltValueNullFieldError.checkNotNull(
                  travelMode, 'DirectionsStep', 'travelMode'),
