...
abstract class DistanceMatrixElement implements Built<DistanceMatrixElement, DistanceMatrixElementBuilder> {
    ...
    factory DistanceMatrixElement([void updates(DistanceMatrixElementBuilder b)]) = _$DistanceMatrixElement;

    @BuiltValueSerializer(custom: true)
    static Serializer<DistanceMatrixElement> get serializer => _$DistanceMatrixElementSerializer();
}

class _$DistanceMatrixElementSerializer implements StructuredSerializer<DistanceMatrixElement> {
    @override
    final Iterable<Type> types = const [DistanceMatrixElement, _$DistanceMatrixElement];
