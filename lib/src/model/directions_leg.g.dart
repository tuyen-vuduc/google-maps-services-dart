...
class _$DirectionsLeg extends DirectionsLeg {
  ...
  _$DirectionsLeg._(
    ...
    BuiltValueNullFieldError.checkNotNull(
        endLocation, 'DirectionsLeg', 'endLocation');
    BuiltValueNullFieldError.checkNotNull(
        startAddress, 'DirectionsLeg', 'startAddress');
    BuiltValueNullFieldError.checkNotNull(
        startLocation, 'DirectionsLeg', 'startLocation');
    BuiltValueNullFieldError.checkNotNull(steps, 'DirectionsLeg', 'steps');
    BuiltValueNullFieldError.checkNotNull(
        trafficSpeedEntry, 'DirectionsLeg', 'trafficSpeedEntry');
    BuiltValueNullFieldError.checkNotNull(
        viaWaypoint, 'DirectionsLeg', 'viaWaypoint');
  }
