...
abstract class DirectionsTransitLine implements Built<DirectionsTransitLine, DirectionsTransitLineBuilder> {
    ...
    factory DirectionsTransitLine([void updates(DirectionsTransitLineBuilder b)]) = _$DirectionsTransitLine;

    @BuiltValueSerializer(custom: true)
    static Serializer<DirectionsTransitLine> get serializer => _$DirectionsTransitLineSerializer();
}

class _$DirectionsTransitLineSerializer implements StructuredSerializer<DirectionsTransitLine> {
    @override
    final Iterable<Type> types = const [DirectionsTransitLine, _$DirectionsTransitLine];
    ...
    Iterable<Object?> serialize(Serializers serializers, DirectionsTransitLine object,
        ...
        result
            ...
            ..add(serializers.serialize(object.agencies,
                specifiedType: const FullType(BuiltList, [FullType(DirectionsTransitAgency)])));
        result
            ..add(r'name')
            ...
            switch (key) {
                case r'agencies':
                    final valueDes = serializers.deserialize(value,
                        specifiedType: const FullType(BuiltList, [FullType(DirectionsTransitAgency)])) as BuiltList<DirectionsTransitAgency>;
                ...
                case r'vehicle':
                    final valueDes = serializers.deserialize(value,
                        specifiedType: const FullType(DirectionsTransitVehicle)) as DirectionsTransitVehicle;
