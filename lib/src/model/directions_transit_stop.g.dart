...
class _$DirectionsTransitStop extends DirectionsTransitStop {
  ...
  _$DirectionsTransitStop._({required this.location, required this.name})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(
        location, 'DirectionsTransitStop', 'location');
    BuiltValueNullFieldError.checkNotNull(
        name, 'DirectionsTransitStop', 'name');
  }
...
class DirectionsTransitStopBuilder
  ...
  DirectionsTransitStopBuilder() {
    DirectionsTransitStop._defaults(this);
  }
