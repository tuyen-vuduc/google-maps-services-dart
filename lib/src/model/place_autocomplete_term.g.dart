...
class _$PlaceAutocompleteTerm extends PlaceAutocompleteTerm {
  ...
  _$PlaceAutocompleteTerm._({required this.value, required this.offset})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(
        value, 'PlaceAutocompleteTerm', 'value');
    BuiltValueNullFieldError.checkNotNull(
        offset, 'PlaceAutocompleteTerm', 'offset');
  }
...
class PlaceAutocompleteTermBuilder
  ...
  PlaceAutocompleteTermBuilder() {
    PlaceAutocompleteTerm._defaults(this);
  }
